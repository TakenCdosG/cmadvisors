...
if ($business != false) {
    if (is_array($business)) {
        ...
        $business_label = ', ' . implode(",", $array_tmp);
    } else {
        $business_label = ', ' . $field['choices'][$business];
    }
}
?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            ...
                            <?php if ($contact != false): ?>
                                <div class="sidebar-left-widget widget_text clr  <?php if ($education != false): ?>line-bottom<?php endif; ?>">
                        ...
                        <div class=" <?php if ($has_sideber_content): ?>col-md-8<?php else: ?>col-md-10<?php endif; ?>">
